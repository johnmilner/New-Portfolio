...
var _noframeworkWaypoints = __webpack_require__(5);

var _noframeworkWaypoints2 = _interopRequireDefault(_noframeworkWaypoints);

var _skylake = __webpack_require__(1);

var _skylake2 = _interopRequireDefault(_skylake);
...
function createWaypoint(element, classToToggle, offset, cb) {
  return (0, _jquery2.default)(element).waypoint(function (direction) {
    (0, _jquery2.default)(element).toggleClass(classToToggle);
...
app.revealMenu = function () {
  ...
  tl.from({ el: '.burger-close', p: { y: [-108, 0] }, d: 1600, e: 'Power4InOut', delay: 800 });
